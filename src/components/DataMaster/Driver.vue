  ...
  <v-main class="list">
    ...
    <v-dialog v-model="dialog" persistent max-width="600px">
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-text-field v-model="form.nama_driver" label="Nama Mobil" required></v-text-field>
            ...
            <v-text-field v-model="form.tgl_lahir" label="Tanggal Lahir" required></v-text-field>
            <v-text-field v-model="form.status_tersedia" label="Status Tersedia" required></v-text-field>
          </v-container>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
