      ...
      <v-data-table :headers="headers" :items="drivers" :search="search">
        <template v-slot:[`item.rerata_rating`]="{ item }">
          <div v-for="rating in ratings" :key="rating.id_driver">
            <p v-if="item.id_driver === rating.id_driver">
              {{ rating.reratabaru }}
            </p>
          </div>
        </template>
        ...
        <template v-slot:[`item.upload_bebas_napza`]="{ item }">
          <v-img
            :src="$baseUrl + '/storage/' + item.upload_bebas_napza"
            height="100px"
            width="100px"
            style="object-fit: cover"
          />
        ...
        <template v-slot:[`item.upload_sim`]="{ item }">
          <v-img
            :src="$baseUrl + '/storage/' + item.upload_sim"
            height="100px"
            width="100px"
            style="object-fit: cover"
          />
        ...
        <template v-slot:[`item.upload_sehat_jiwa`]="{ item }">
          <v-img
            :src="$baseUrl + '/storage/' + item.upload_sehat_jiwa"
            height="100px"
            width="100px"
            style="object-fit: cover"
          />
        ...
        <template v-slot:[`item.upload_sehat_jasmani`]="{ item }">
          <v-img
            :src="$baseUrl + '/storage/' + item.upload_sehat_jasmani"
            height="100px"
            width="100px"
            style="object-fit: cover"
          />
        ...
        <template v-slot:[`item.upload_skck`]="{ item }">
          <v-img
            :src="$baseUrl + '/storage/' + item.upload_skck"
            height="100px"
            width="100px"
            style="object-fit: cover"
          />
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <v-menu offset-y>
            ...
            <v-list>
              <v-list-item-title>
                <v-btn @click="editHandler(item)"> Edit Driver </v-btn>
              </v-list-item-title>

              <v-list-item-title>
                <v-btn @click="showHandler(item)"> Lihat Berkas </v-btn>
              </v-list-item-title>
            </v-list>
          </v-menu>
        </template>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            ...
            <v-select
              :items="statusTersedia"
              v-model="form.status_tersedia"
            ...
            ></v-select>
            <v-text-field
              v-model="form.biaya_sewa_driver"
              label="Biaya sewa Driver"
              required
            ></v-text-field>
            <v-text-field
            ...
            <v-file-input
              ...
              filled
              prepend-icon="mdi-camera"
              label="Foto Sehat Jiwa"
              id="fotoSehatJiwa"
              ref="filefotoSehatJiwa"
            ></v-file-input>
            ...
            <v-file-input
              ...
              filled
              prepend-icon="mdi-camera"
              label="Foto Sehat Jasmani"
              id="fotoSehatJasmani"
              ref="filefotoSehatJasmani"
            ></v-file-input>
          ...
          <v-container>
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.foto_driver
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.upload_sim
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.upload_bebas_napza
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.upload_sehat_jiwa
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.upload_sehat_jasmani
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
            ...
            <v-flex align-center>
              <v-img
                ...
                :src="
                  previewImageUrl == ''
                    ? $baseUrl + '/storage/' + form.upload_skck
                    : previewImageUrl
                "
                id="previewImage"
                class="mb-5"
